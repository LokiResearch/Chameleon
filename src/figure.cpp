...
Figure::Figure(int id, int width, int height, std::vector<KeyPoint> keypoints, Mat descriptors, QUrl url) :
    id(id), width(width), height(height), keypoints(keypoints), descriptors(descriptors), url(url) {
